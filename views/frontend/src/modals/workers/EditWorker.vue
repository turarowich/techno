<template>
  <div class="modal fade right" id="edit-worker" tabindex="-1" role="dialog" aria-labelledby="edit-worker"
    aria-hidden="true">
 ...
 role="document">
      <div class="modal-content myModal-content h-100">
        <div class="modal-header align-items-center">
          <h3 class="modal-title">Изменить работника</h3>
        ...
        <div class="myModal-body edit-worker">
          ...
          <div class="d-flex btns">
            <button class="save mr-2" @click="onSubmit">Изменить</button>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.axios.put(this.url('updateWorker', worker._id), form)
        .then(() => {
          setTimeout(() => {
          ...
          this.$successAlert('Работник успешно изменен')
        }).catch((error) => {
  ...
  watch: {
    select_client(newWorker) {
      this.worker = Object.assign({}, newWorker)
    }
  },
  mounted() {
