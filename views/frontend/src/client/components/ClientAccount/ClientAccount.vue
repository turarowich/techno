...
<div class="row">
  <div class="col-lg-10 m-auto">
    ...
    <div class="bonus-notification">
        <div class="d-flex align-items-center">
           <img class="mr-2" src="../../../assets/clients/Discount.svg"> <span>My bonuses: 100</span>
        </div>
...
name: "ClientAccount",
  ...
  return{
    orderList:[
      ...
      {id:5,name:"Essentialsss",client:"Tomas Levins", phone:"0500687909", total:"120 $",date:"2021-03-19",notes:"Please,",status:'Done'},
