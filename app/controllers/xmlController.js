...
insertProducts = async function (Product, Category, settings, companyName) {
    console.log("CALLED insertProducts");
    ...
    for (const pro of productsArray) {
        ...
        if (!productCheck) {
            ...
            try {
                ...
                console.log(e, "OLD PRODUCT");
            }

        }

    }
    console.log(count1, count2, "COUNTS");
}

createCategory = async function (name, oneCId, Category, type = "product",) {
    try {
